...
DGS2 advantages:
  - Goes back to 1976, covering every historical hiking cycle
...
def main():
    ...
    # data coverage floor: DGS3MO starts 1981-09-08, DFEDTAR starts 1982-09-27.
    # The practical first day where all signal inputs exist is late 1982.
